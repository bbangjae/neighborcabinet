        ...
        <div class="join_content">
            <div class="join_form">
                <form id="join_form" method="GET" action="/user2/V2Join?m=begin" >
                    <input type="hidden" id="token_sjoin" name="token_sjoin" value="wm2qbjtCoj2Lm1s2">
                    ...
                    <div class="terms_p">
                        <p class="terms_chk_all">
								<span class="input_chk">
									...
									<label for="chk_all"><span class="chk_all_txt">네이버 이용약관, 개인정보 수집 및 이용, 위치기반서비스 이용약관(선택),<br class='m_br'> 프로모션 정보 수신(선택)에 모두 동의합니다.</span></label>
		                        </span>
                        </p>
                        <ul class="terms_bx_list">
                            ...
                            <li class="terms_bx">
									<span class="input_chk">
                                        ...
                                        <a href="#" id="termForChild" class="easy_guide" role="button" target="_blank"><span class="txt">어린이용 안내</span></a>
									</span>
                                    ...
                                    <div class="article">
                                        ...
                                        <div class="clause">
                                            ...
                                            <ul class="sections">
                                                ...
                                                <li class="sections__section">- 네이버 플러스 멤버십 서비스 혜택 중복 제공 방지
                                        ...
                                        <div class="clause">
                                            ...
                                            <ul class="sections">
                                                ...
                                                <li class="sections__section">- 전자서명 인증 업무
                                                    <br>인증서와 인증 업무에 관한 기록: 인증서 효력 상실일로부터 10년 보관
                                                </li>
                                                <li class="sections__section">- 통신비밀보호법
                                                    <br>로그인 기록: 3개월<br><br>
                                                </li>
                                            </ul>
                                            <p class="clause__text"><p class="clause__text">
                            ...
                            <li class="terms_bx">
									<span class="input_chk">
										...
										<label for="termsLocation">위치기반서비스 이용약관 동의<span class="terms_choice terms_no">(선택)</span></label>
									</span>
                                <!-- tg-lang=>"ko" -->
                                <div class="terms_box" id="divLocation">
                                    ...
                                    <div class="article">
                                        ...
                                        <ol class="section">
                                            <li>
                                                ...
                                                <ol class="section">
                                                    <li>1. GeoTagging 서비스: 게시물 또는 이용자가 저장하는 콘텐츠에 포함된 개인위치정보주체 또는 이동성 있는 기기의 위치정보가 게시물과 함께 저장됩니다. 저장된 위치정보는 별도의 활용없이 보관되거나, 또는 장소를 기반으로 콘텐츠를 분류하거나 검색할 수 있는 기능이 제공될 수도 있습니다.</li>
                                                    <li>2. 위치정보를 활용한 검색결과 및 콘텐츠 제공 : 정보 검색을 요청하거나 개인위치정보주체 또는 이동성 있는 기기의 위치정보를 제공 시 본 위치정보를 이용한 검색결과, 주변결과(맛집, 주변업체, 교통수단 등), 번역결과를 제시합니다.</li>
                                                    <li>3. 이용자 위치를 활용한 광고정보 제공: 검색결과 또는 기타 서비스 이용 과정에서 개인위치정보주체 또는 이동성 있는 기기의 위치를 이용하여 광고소재를 제시합니다.</li>
                                                    <li>4. 이용자 보호 및 부정 이용 방지: 개인위치정보주체 또는 이동성 있는 기기의 위치를 이용하여 권한없는 자의 비정상적인 서비스 이용 시도 등을 차단합니다.</li>
                                                    <li>5. 길 안내 등 생활편의 서비스 제공: 교통정보와 길 안내 등 최적의 경로를 지도로 제공하며, 주변 시설물 찾기, 뉴스/날씨 등 생활정보, 긴급구조 서비스, 주소 자동 입력 등 다양한 운전 및 생활 편의 서비스를 제공합니다.</li>
                                                </ol>
                                            </li>
                                    ...
                                    <div class="article">
                                        ...
                                        <ol class="section">
                                            ...
                                            <li>
                                                <p>④ 개인위치정보주체는 회사에 대하여 아래 자료의 열람 또는 고지를 요구할 수 있고, 당해 자료에 오류가 있는 경우에는 그 정정을 요구할 수 있습니다. 이 경우 회사는 정당한 이유 없이 요구를 거절하지 아니합니다.</p>
                                                <ol class="section">
                                    ...
                                    <div class="article">
                                        <h3 class="article__title">제 6 조 (위치정보 이용·제공사실 확인자료 보유근거 및 보유기간)</h3>
                                        <ol class="section">
                                            <li>회사는 위치정보의 보호 및 이용 등에 관한 법률 제16조 제2항에 근거하여 개인위치정보주체에 대한 위치정보 수집·이용·제공사실 확인자료를 위치정보시스템에 자동으로 기록하며, 6개월 이상 보관합니다.</li>
                                        </ol>
                                    </div>
                                    <div class="article">
                                    ...
                                    <div class="article">
                                        ...
                                        <ol class="section">
                                            <li>
                                                <p>① 회사는 아래의 경우에 해당하는 자(이하 “8세 이하의 아동 등"이라 함)의 보호의무자가 8세 이하의 아동 등의 생명 또는 신체보호를 위하여 개인위치정보의 이용 또는 제공에 동의하는 경우에는 본인의 동의가 있는 것으로 봅니다.</p>
                                                <ol class="section">
                                                    <li>1. 8세 이하의 아동</li>
                                                    <li>2. 피성년후견인</li>
                                                    <li>3. 장애인복지법 제2조제2항제2호의 규정에 의한 정신적 장애를 가진 자로서 장애인고용촉진 및 직업재활법 제2조제2호의 규정에 의한 중증장애인에 해당하는 자(장애인복지법 제32조의 규정에 의하여 장애인등록을 한 자에 한정)</li>
                                                </ol>
                                            </li>
                                    ...
                                    <div class="article">
                                        ...
                                        <ol class="section">
                                            ...
                                            <li>② 회사는 대부분의 위치기반서비스에서 개인위치정보를 일회성 또는 임시로 이용 후 지체없이 파기합니다. 단, ‘GeoTagging’ 서비스와 같이 이용자가 게시물, 콘텐츠와 함께 개인위치정보를 네이버 서비스에 게시 또는 보관하는 경우, 해당 게시물, 콘텐츠의 보관기간 동안 개인위치정보가 함께 보관됩니다.</li>
                                        </ol>
                                    </div>
                                    <div class="article">
                                        <h3 class="article__title">제 11 조 (손해배상)</h3>
                                        <ol class="section">
                                            <li>개인위치정보주체는 회사의 위치정보의 보호 및 이용 등에 관한 법률 제15조 내지 26조의 규정을 위반한 행위로 손해를 입은 경우에 회사에 대하여 손해배상을 청구할 수 있습니다. 이 경우 회사는 고의 또는 과실이 없음을 입증하지 아니하면 책임을 면할 수 없습니다.</li>
                                        </ol>
                                    </div>
                                    <div class="article">
                                        ...
                                        <ol class="section">
                                            ...
                                            <li>
                                                ...
                                                <ol class="section">
                                                    ...
                                                    <li>- 메일 : <a href="https://help.naver.com/alias/privacy/privacy_25.naver" target="_blank">문의하기</a></li>
                                                </ol>
                                            </li>
                                        </ol>
                                    </div>
                                    <div class="article">
                                        ...
                                        <ol class="section">
                                            <li>2022년 4월 27일부터 시행되던 종전의 약관은 본 약관으로 대체하며, 본 약관은 2022년 5월 18일부터 적용됩니다.</li>
                                        </ol>
                                    </div>                                </div>
                                <!-- tg-lang -->
                            </li>
                            <li class="terms_bx">
									<span class="input_chk">
										...
										<label for="termsEmail">프로모션 정보 수신 동의<span class="terms_choice terms_no">(선택)</span></label>
									</span>
                            </li>
                        </ul>
                    ...
                    <div class="btn_area double">
                        ...
                        <span><!-- tg-text=terms_button_agree --><a href="#" id="btnAgree" class="btn_type btn_primary" role="button">확인</a></span>
                    </div>
                </form>
