	...
	<body>
		<div class="wrap">
			<div class="navBlock">
				...
				<div class="sub1"><span class="pageInfo">마이페이지 → 개인정보</span></div>
				<div class="sub2"><h1 class="pageName">개인정보</h1></div>
			<div class="modifyinfoBox">
				<div class="userName">
					<div class="inputbtnBox">
						<span class="modifySpan">실명</span>
							<button class="modifyButton" onClick="toggleform()">
									<img src="/image/gear.png" class="btnImage">
							</button>
					</div>
						<div class="currentName">
							<span class="modifySpan2">실명</span>
						</div><hr>
					<form class="showForm">
						<div class="formBox">
							<div class="formInput">
