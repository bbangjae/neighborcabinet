	...
	width:100%;">
				...
				<div id="sectionBox">
					...
					<ul id="section_1">
						<li><table>
							<tr>
								<td rowspan="3"><img src="<c:url value="/image/homeImg.png"/>" style="height : 80px;
	width : 80px;"></td>
						...
						<c:forEach var="rent" items="${RentCom}">
							<li><table>
								<tr>
									<td rowspan="3">이미지</td>
									<td colspan="2"><a href="<c:url value='/mypage/review/1'/>">${rent.rentPlace }${rent.rentState }</a></td>
								</tr>
								<tr>
									<td colspan="2">주소</td>
								</tr>
